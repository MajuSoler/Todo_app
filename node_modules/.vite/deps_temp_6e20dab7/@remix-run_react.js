...
var DataRouterHook = function(DataRouterHook4) {
  DataRouterHook4["UseBlocker"] = "useBlocker";
  DataRouterHook4["UseRevalidator"] = "useRevalidator";
  DataRouterHook4["UseNavigateStable"] = "useNavigate";
...
var RemixContext = React4.createContext(void 0);
...
var NavLink2 = React4.forwardRef(({
  to,
  prefetch = "none",
  ...props
}, forwardedRef) => {
  ...
  return React4.createElement(React4.Fragment, null, React4.createElement(NavLink, _extends3({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to
  })), shouldPrefetch && !isAbsolute ? React4.createElement(PrefetchPageLinks, {
    page: href
  }) : null);
});
NavLink2.displayName = "NavLink";
var Link2 = React4.forwardRef(({
  to,
  prefetch = "none",
  ...props
}, forwardedRef) => {
  ...
  let href = useHref(to);
  let [shouldPrefetch, ref, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return React4.createElement(React4.Fragment, null, React4.createElement(Link, _extends3({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to
  })), shouldPrefetch && !isAbsolute ? React4.createElement(PrefetchPageLinks, {
    page: href
...
function Links() {
  ...
  return React4.createElement(React4.Fragment, null, criticalCss ? React4.createElement("style", {
    dangerouslySetInnerHTML: {
      __html: criticalCss
    }
  }) : null, keyedLinks.map(({
    key,
    link
  }) => isPageLinkDescriptor(link) ? React4.createElement(PrefetchPageLinks, _extends3({
    key
  }, link)) : React4.createElement("link", _extends3({
    key
  }, link))));
}
function PrefetchPageLinks({
  ...
  return React4.createElement(PrefetchPageLinksImpl, _extends3({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  if (!future.unstable_singleFetch) {
    linksToRender = dataHrefs.map((href) => React4.createElement("link", _extends3({
      key: href,
      rel: "prefetch",
      as: "fetch",
      href
    ...
    if (url.searchParams.get("_routes") !== "") {
      linksToRender = React4.createElement("link", _extends3({
    ...
    ;
  return React4.createElement(React4.Fragment, null, linksToRender, moduleHrefs.map((href) => React4.createElement("link", _extends3({
    key: href,
    rel: "modulepreload",
    href
    ...
    React4.createElement("link", _extends3({
      key
    }, link))
  )));
}
function Meta() {
  ...
  return React4.createElement(React4.Fragment, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return React4.createElement(Comp, _extends3({
        key: JSON.stringify(rest)
      }, rest));
    }
    if ("title" in metaProps) {
      return React4.createElement("title", {
        key: "title"
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? React4.createElement("meta", {
        key: "charSet",
    ...
    if ("script:ld+json" in metaProps) {
      try {
        ...
        return React4.createElement("script", {
    ...
    return React4.createElement("meta", _extends3({
...
function Await2(props) {
  return React4.createElement(Await, props);
}
    ...
    contextScript += !activeDeferreds ? "" : ["__remixContext.p = function(v,e,p,x) {", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p=Promise.reject(x);", "  } else {", "    p=Promise.resolve(v);", "  }", "  return p;", "};", "__remixContext.n = function(i,k) {", "  __remixContext.t = __remixContext.t || {};", "  __remixContext.t[i] = __remixContext.t[i] || {};", "  let p = new Promise((r, e) => {__remixContext.t[i][k] = {r:(v)=>{r(v);},e:(v)=>{e(v);}};});", typeof abortDelay === "number" ? `setTimeout(() => {if(typeof p._error !== "undefined" || typeof p._data !== "undefined"){return;} __remixContext.t[i][k].e(new Error("Server timeout."))}, ${abortDelay});` : "", "  return p;", "};", "__remixContext.r = function(i,k,v,e,p,x) {", "  p = __remixContext.t[i][k];", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p.e(x);", "  } else {", "    p.r(v);", "  }", "};"].join("\n") + Object.entries(activeDeferreds).map(([routeId, deferredData]) => {
      ...
      let promiseKeyValues = deferredData.deferredKeys.map((key) => {
        if (pendingKeys.has(key)) {
          deferredScripts.push(React4.createElement(DeferredHydrationScript, {
            key: `${routeId} | ${key}`,
            deferredData,
            routeId,
            dataKey: key,
...
import(${JSON.stringify(manifest.entry.module)});`;
    return React4.createElement(React4.Fragment, null, React4.createElement("script", _extends3({}, props, {
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    })), React4.createElement("script", _extends3({}, props, {
      suppressHydrationWarning: true,
  ...
  return isHydrated ? null : React4.createElement(React4.Fragment, null, React4.createElement("link", {
    rel: "modulepreload",
    href: manifest.url,
    crossOrigin: props.crossOrigin
  }), React4.createElement("link", {
    rel: "modulepreload",
    href: manifest.entry.module,
    crossOrigin: props.crossOrigin
  }), dedupe(preloads).map((path) => React4.createElement("link", {
    key: path,
    rel: "modulepreload",
    href: path,
    crossOrigin: props.crossOrigin
...
function DeferredHydrationScript({
  ...
  return React4.createElement(React4.Suspense, {
    fallback: (
      // This makes absolutely no sense. The server renders null as a fallback,
      // but when hydrating, we need to render a script tag to avoid a hydration issue.
      // To reproduce a hydration mismatch, just render null as a fallback.
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : React4.createElement("script", _extends3({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
  ...
  }, typeof document === "undefined" && deferredData && dataKey && routeId ? React4.createElement(Await2, {
    resolve: deferredData.data[dataKey],
    errorElement: React4.createElement(ErrorDeferredHydrationScript, {
      dataKey,
      routeId,
      scriptProps,
      serializeError
    ...
    children: (data) => {
      return React4.createElement("script", _extends3({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
  ...
  }) : React4.createElement("script", _extends3({}, scriptProps, {
    async: true,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: " "
...
function RemixRootDefaultErrorBoundary({
  ...
  }, "Application Error"), React5.createElement("pre", {
    style: {
      padding: "2rem",
...
function BoundaryShell({
  ...
  }), React5.createElement("title", null, title)), React5.createElement("body", null, React5.createElement("main", {
    style: {
      fontFamily: "system-ui, sans-serif",
      padding: "2rem"
    }
  }, children, renderScripts ? React5.createElement(Scripts, null) : null)));
}
...
function RemixRootDefaultHydrateFallback() {
  return React6.createElement(BoundaryShell, {
    title: "Loading...",
    renderScripts: true
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => React7.createElement(RemixRootDefaultErrorBoundary, {
    error: useRouteError()
  }) : void 0;
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component3 ? {
        element: React7.createElement(routeModule.Layout, null, React7.createElement(Component3, null))
      } : {
...
function RemixBrowser(_props) {
  if (!router) {
    ...
    if (initialPathname !== hydratedPathname && !window.__remixContext.isSpaMode) {
      ...
      window.location.reload();
      return React8.createElement(React8.Fragment, null);
    }
  ...
  return (
    ...
    React8.createElement(React8.Fragment, null, React8.createElement(RemixContext.Provider, {
      value: {
    ...
    }, React8.createElement(RemixErrorBoundary, {
      location
    }, React8.createElement(RouterProvider, {
      router,
      fallbackElement: null,
      future: {
        v7_startTransition: true
      }
    }))), window.__remixContext.future.unstable_singleFetch ? React8.createElement(React8.Fragment, null) : null)
  );
}
...
function ScrollRestoration2({
  ...
  return React9.createElement("script", _extends3({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
function getFormEncType2(encType) {
  if (encType != null && !supportedFormEncTypes2.has(encType)) {
    true ? warning(false, `"${encType}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${defaultEncType2}"`) : void 0;
    return null;
  }
  return encType;
}
...
var ViewTransitionContext2 = React10.createContext({
  isTransitioning: false
});
if (true) {
  ViewTransitionContext2.displayName = "ViewTransition";
}
var FetchersContext2 = React10.createContext(/* @__PURE__ */ new Map());
if (true) {
...
var Link3 = React10.forwardRef(function LinkWithRef2({
  onClick,
  relative,
  reloadDocument,
  replace,
  ...
  return (
    // eslint-disable-next-line jsx-a11y/anchor-has-content
    React10.createElement("a", Object.assign({}, rest, {
      href: absoluteHref || href,
      onClick: isExternal || reloadDocument ? onClick : handleClick,
      ref,
      target
...
var NavLink3 = React10.forwardRef(function NavLinkWithRef2({
  "aria-current": ariaCurrentProp = "page",
  caseSensitive = false,
  className: classNameProp = "",
  end = false,
  ...
  let style = typeof styleProp === "function" ? styleProp(renderProps) : styleProp;
  return React10.createElement(Link3, Object.assign({}, rest, {
    "aria-current": ariaCurrent,
    className,
    ref,
    style,
...
var Form2 = React10.forwardRef(({
  ...
  let submitHandler = (event) => {
    ...
    event.preventDefault();
    let submitter = event.nativeEvent.submitter;
    let submitMethod = (submitter == null ? void 0 : submitter.getAttribute("formmethod")) || _method;
    submit(submitter || event.currentTarget, {
      fetcherKey,
      method: submitMethod,
      navigate,
  ...
  return React10.createElement("form", Object.assign({
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
    onSubmit: reloadDocument ? onSubmit : submitHandler
...
if (true)
  ;
var DataRouterHook3 = function(DataRouterHook4) {
  DataRouterHook4["UseScrollRestoration"] = "useScrollRestoration";
  DataRouterHook4["UseSubmit"] = "useSubmit";
  DataRouterHook4["UseSubmitFetcher"] = "useSubmitFetcher";
  DataRouterHook4["UseFetcher"] = "useFetcher";
...
function useDataRouterContext4(hookName) {
  ...
  !ctx ? true ? invariant(false, getDataRouterConsoleError3(hookName)) : invariant(false) : void 0;
  return ctx;
}
...
function useSubmit2() {
  ...
  let currentRouteId = useRouteId();
  return React10.useCallback((target, options = {}) => {
...
function useViewTransitionState2(to, opts = {}) {
  let vtContext = React10.useContext(ViewTransitionContext2);
  !(vtContext != null) ? true ? invariant(false, "`unstable_useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?") : invariant(false) : void 0;
  let {
    basename
...
function StaticRouterProvider({
  ...
  return React10.createElement(React10.Fragment, null, React10.createElement(DataRouterContext.Provider, {
    value: dataRouterContext
  }, React10.createElement(DataRouterStateContext.Provider, {
    value: state
  }, React10.createElement(FetchersContext2.Provider, {
    value: fetchersContext
  }, React10.createElement(ViewTransitionContext2.Provider, {
    value: {
      isTransitioning: false
    }
  }, React10.createElement(Router, {
  ...
  }, React10.createElement(DataRoutes2, {
    routes: router2.routes,
    future: router2.future,
    state
  })))))), hydrateScript ? React10.createElement("script", {
    suppressHydrationWarning: true,
    nonce,
    dangerouslySetInnerHTML: {
...
function RemixServer({
  ...
  return React11.createElement(React11.Fragment, null, React11.createElement(RemixContext.Provider, {
    value: {
      manifest,
      routeModules,
      criticalCss,
  ...
  }, React11.createElement(RemixErrorBoundary, {
    location: router2.state.location
  }, React11.createElement(StaticRouterProvider, {
    router: router2,
    context: context.staticHandlerContext,
    hydrate: false
  }))), context.future.unstable_singleFetch && context.serverHandoffStream ? React11.createElement(React11.Suspense, null, React11.createElement(StreamTransfer, {
    context,
    identifier: 0,
