...
const getStylesForUrl = async ({
  ...
  let documentRouteFiles = ((_matchRoutes = router.matchRoutes(routes, url, build.basename)) === null || _matchRoutes === void 0 ? void 0 : _matchRoutes.map(match => path__namespace.join(appPath, remixConfig.routes[match.route.id].file))) ?? [];
